    ...
    <main className="min-h-dvh bg-[#1C1C1C]">
      <section className="relative overflow-hidden">
          ...
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:items-start">
              <div className="relative w-full sm:w-auto sm:inline-flex">
                ...
                >
                  <FaCalendar className="text-lg sm:text-xl md:text-2xl" />
                  Prendre RDV
                </a>
        ...
        <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute left-1/2 top-1/2 h-[300px] w-[300px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[rgba(113,221,174,0.25)] blur-[120px] sm:h-[400px] sm:w-[400px] sm:blur-[160px] md:h-[520px] md:w-[520px] md:blur-[220px]"></div>
          <div className="absolute left-1/4 top-1/4 h-[200px] w-[200px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[rgba(255,255,255,0.18)] blur-[100px] sm:h-[280px] sm:w-[280px] sm:blur-[140px] md:h-[360px] md:w-[360px] md:blur-[200px]"></div>
        </div>
      </section>
    </main>
  );
